...
public class FutureRidesOffered extends Activity {
    ...
    private void populateFutureRidesList() {
        ...
        if (userId == -1 ) {
            Log.e("Future Rides Offered: ", "No user Id found in shared preferences file");
            return;
        }

        if (requestQueue != null) {
            String baseUrl = getResources().getString(R.string.BASE_URL);
            String targetUrl = baseUrl + getResources().getString(R.string.API_GET_FUTURE_RIDES_OFFERED);
    ...
    private void populateList(ArrayList<Ride> rides) {
        ListView ridesList = (ListView) findViewById(R.id.lvFutureRidesOffered);
